...
export function AvailabilityKey() {
  return (
    <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
      <span className="font-mono text-[10px] tracking-[0.14em] whitespace-nowrap text-mute/60 uppercase">
        Availability
      </span>
      {SCALE.map(([dot, label]) => (
        <span
          key={label}
          className="flex items-center gap-1.5 font-mono text-[11px] whitespace-nowrap text-mute"
        >
